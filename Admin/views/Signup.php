...
<body>
    <div class="signup-container">
        ...
        <?php if (!empty($general_error)): ?>
            <div class="general-error-message"><?php echo $general_error; ?></div>
        <?php endif; ?>
        ...
        <?php if (!empty($_SESSION['success_error'])): ?>
            <div class="general-error-message"><?php echo $_SESSION['success_error']; unset($_SESSION['success_error']); ?></div>
        <?php endif; ?>
