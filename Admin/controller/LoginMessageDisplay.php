...
if (!empty($_SESSION['login_success_message'])) {
    $messages[] = ['type' => 'success-message', 'text' => $_SESSION['login_success_message']];
...
if (!empty($_SESSION['login_info_message'])) {
    $messages[] = ['type' => 'info-message', 'text' => $_SESSION['login_info_message']];
    unset($_SESSION['login_info_message']);
}
if (!empty($_SESSION['login_warning_message'])) {
    $messages[] = ['type' => 'warning-message', 'text' => $_SESSION['login_warning_message']];
    unset($_SESSION['login_warning_message']);
}
